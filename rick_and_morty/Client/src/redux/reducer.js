import { ADD_FAVORITE, REMOVE_FAVORITE, FILTER, ORDER, SHOW_ALL_FAVORITES } from "./actions";
const initialState = { myFavorites: [], allCharacters: [] };

const rootReducer = (state = initialState, action) => {
  switch (action.type) {
    case ADD_FAVORITE:
      return { ...state, myFavorites: action.payload, allCharacters: action.payload }; //express
      // return {
      //   ...state,
    ...
    case FILTER:
      ...
      return {
        ...state, 
        myFavorites: state.allCharacters.filter( //hago el filtrado en la copia de los favoritos para consevar a todos los favoritos una vez hecho el filtro. 
